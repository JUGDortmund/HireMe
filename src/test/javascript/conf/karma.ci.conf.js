module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'http://localhost:8080/webjars/angular-elastic/2.4.2/elastic.js',
            'http://localhost:8080/webjars/rangy/1.3.0/rangy-core.js',
            'http://localhost:8080/webjars/rangy/1.3.0/rangy-selectionsaverestore.js',
            'http://localhost:8080/webjars/textAngular/1.4.1/textAngular-sanitize.min.js',
            'http://localhost:8080/webjars/textAngular/1.4.1/textAngular.min.js',
