...
public class ProfileExportServiceTest {
  ...
  public void getNameFromTemplate() throws Exception {
    assertThat(profileExportService.getTemplateDefinitions().get(0).getName()).isEqualTo(
        "TestTemplate");
    assertThat(profileExportService.getTemplateDefinitions().get(0).getTemplatePath()).isEqualTo(
        "template.ftl.html");
  }
